...
def student_home(request):
    ...
    if request.method == 'POST':
        ...
        if enroll_response.status_code == 201:
            ...
            return HttpResponse("You can't enroll greater than 5 courses")
...
def download_file(request, file_id):
    ...
    # Step 1: Get file metadata from API
    file_meta_url = f'http://127.0.0.1:8000/api/courses/CourseFiles/{file_id}/'
    response = api_request_with_refresh(request, 'GET', file_meta_url)
    ...
    file_url = file_data['file']  # e.g. "http://127.0.0.1:8000/media/.../django-Edge.jpeg"
