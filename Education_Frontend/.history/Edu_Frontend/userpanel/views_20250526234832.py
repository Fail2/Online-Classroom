...
def edit_file(request, file_id, course_id):
    ...
    get_url = f'http://127.0.0.1:8000/api/courses/files/{file_id}/'
    response = api_request_with_refresh(request, 'GET', get_url)
    ...
    if request.method == 'POST':
        ...
        if updated_data or files:
            patch_url = f'http://127.0.0.1:8000/api/courses/files/{file_id}/'
...
def delete_file(request, file_id, course_id):
    delete_url = f'http://127.0.0.1:8000/api/courses/files/{file_id}/'
