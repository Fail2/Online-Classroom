...
urlpatterns = [
    ...
    path('teacher/edit/course/file/<int:course_id>/',views.edit_file, name = 'edit-file'),
    path('teacher/delete/course/file/<int:course_id>/',views.delete_file, name = 'delete-file'),
