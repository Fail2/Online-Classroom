...
from utils.api_helpers import api_request_with_refresh  # Your helper function

def student_course_files(request, course_id):
    student_id = request.session.get('user_id')

    # Step 1: Check if student is enrolled in this course
    enrollment_check_url = f"http://127.0.0.1:8000/api/enrollments/student/{student_id}/"
    ...
    course_files_url = f"http://127.0.0.1:8000/api/files/by-course/{course_id}/"
